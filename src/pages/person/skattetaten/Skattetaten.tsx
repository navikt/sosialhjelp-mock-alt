    ...
    return (
        <Collapse isOpened={isOpen}>
            <Panel border={true}>
                ...
                />
                <Select label="Måned"
                        onChange={(evt: any) => setManed(evt.target.value)}
                        value={maned}
                >
                ...
                >
                    ...
                    <option value={SkatteutbetalingType.ALDERSUFOEREETTERLATTEAVTALEFESTETOGKRIGSPENSJON}>Alder, uføre,
                        etterlatte, avtalefestet og krigspensjon
                    </option>
                </Select>
                <Knapp
