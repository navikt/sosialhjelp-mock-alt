    ...
    return (
        <Collapse isOpened={isOpen}>
            <Panel border={true}>
                ...
                <Select label="Folkeregisterpersonstatus"
...
export const VisBarn = ({barn}: ViseParams) => {
    return (<Panel border={true}>
            ...
            <div>Navn: {barn.navn.fornavn} {barn.navn.mellomnavn} {barn.navn.etternavn}</div>
            ...
            <div>Addresse: {barn.bostedsadresse.adressenavn}, {barn.bostedsadresse.husnummer}, {" "}
