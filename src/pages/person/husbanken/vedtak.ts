...
export const Vedtakskode: { [key in VedtakKodeType]: string } = {
    ...
    V05:
        'Du har fått avslag på søknaden din om bostøtte fordi du ikke var registrert på søknadsadressen i folkeregisteret.',
    V07: 'Klagen din ble avvist da den ble sendt inn etter klagefristen.',
    V09:
        'Søknaden din om bostøtte er avvist fordi det mangler opplysninger eller dokumentasjon, eller fordi noen i husstanden er registrert på en annen søknad.',
    V11: 'Hovedperson er død',
    V12: 'For høy anslått inntekt (ikke i bruk lengre)',
    V48:
        'Søknaden din om bostøtte er avvist fordi noen du bor sammen med ikke er registrert på adressen i folkeregisteret.',
};
